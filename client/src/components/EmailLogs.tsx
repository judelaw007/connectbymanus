...
export default function EmailLogs() {
  const { data: emailLogs, isLoading, error } = trpc.emailLogs.getAll.useQuery({ limit: 100 });
  ...
  return (
    <Card>
      ...
      <CardContent>
        {isLoading ? (
          <div className="text-center text-muted-foreground py-8">Loading email logs...</div>
        ) : (
